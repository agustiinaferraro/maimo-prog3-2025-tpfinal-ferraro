...
const About = () => {
  ...
  return (
    <div className="relative flex items-center justify-center px-4 sm:px-6 py-6 md:py-10">
      ...
      <div className="relative flex flex-col md:flex-row items-center md:items-center gap-14 w-full max-w-7xl mx-auto text-white">
