  ...
  if (isCarousel) {
    ...
    return (
      <div className="py-10 px-4 sm:px-6">
        <div className="-ml-4 sm:-ml-6 flex items-center justify-end gap-3 pr-6 h-14 bg-white border border-gray-200 border-l-0 rounded-r-xl shadow-md mb-8 max-w-sm sm:max-w-md">
