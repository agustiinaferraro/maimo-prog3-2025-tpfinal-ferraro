  ...
  if (isCarousel) {
    ...
    return (
      <div className="py-10 px-4 sm:px-6">
        <div className="-ml-4 sm:-ml-6 w-[calc(100%+1rem)] sm:w-[calc(100%+1.5rem)] bg-white border border-gray-200 border-l-0 rounded-r-xl shadow-md mb-8">
          <div className="max-w-7xl mx-auto flex items-center justify-end gap-3 h-14 pr-6">
            ...
            <h3 className="text-3xl font-bold text-black">Actividades</h3>
          </div>
        </div>
